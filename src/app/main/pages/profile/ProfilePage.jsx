						...
						<div className="text-center px-14">
							...
							<div className={classes.smallerInfo}>
								<div className={classes.smallerInfoRow}>
									...
									<div>Yazan Basel{user.data.teacherName}</div>
								</div>
								<div className={classes.smallerInfoRow}>
			...
			{lessonsArr.map(item => (
				...
				>
					<div className={classes.lessonInner}>
						<div>
							<span style={{ display: 'inline-block', marginLeft: '20px', marginRight: '50px' }}>
								{item.lessonName}
							</span>
							...
							<Box sx={modalStyle}>
								...
								<Typography id="transition-modal-description" sx={{ mt: 2 }}>
									<div className={classes.smallerInfo} style={{ padding: '10px' }}>
										...
										<div className={classes.smallerInfoRow}>
											<div className="font-semibold">Time to Finish:</div>
											<div>40 seconds</div>
										</div>
										<div className={classes.smallerInfoRow}>
										...
										<div className={classes.smallerInfoRow}>
											<div className="font-semibold">Mistakes:</div>
											<div>7 mistakes</div>
										</div>
									</div>
								</Typography>
